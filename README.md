...
│   ├── customer-support/        #   Ticket intake → sentiment/category/priority → response
...
└── tests/                       # Test suite (1213 tests, 25 suites, auto-discovered runner)
```
...
cd motus
npm install
npm test                              # 1213 tests across 25 suites
