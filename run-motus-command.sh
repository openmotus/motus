...
COMMAND=$1
LOGFILE="/Users/ianwinscom/motus/logs/automation-$(date +%Y%m%d).log"
...
case "$COMMAND" in
    "daily-brief")
        ...
        node /Users/ianwinscom/motus/run-automated-workflow.js daily-brief >> "$LOGFILE" 2>&1
        ;;
    "evening-report")
        echo "Running Evening Report workflow..." >> "$LOGFILE"
        # Run the evening report workflow
        node /Users/ianwinscom/motus/run-automated-workflow.js evening-report >> "$LOGFILE" 2>&1
        ;;
    *)
